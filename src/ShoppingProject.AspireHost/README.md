...
1. Set `ShoppingProject.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../ShoppingProject.Infrastructure/ShoppingProject.Infrastructure.csproj -s ShoppingProject.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../ShoppingProject.Infrastructure/ShoppingProject.Infrastructure.csproj -s ShoppingProject.Web.csproj
```
