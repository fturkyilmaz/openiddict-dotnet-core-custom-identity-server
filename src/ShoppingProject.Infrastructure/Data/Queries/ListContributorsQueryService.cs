...
using ShoppingProject.UseCases.Contributors;
using ShoppingProject.UseCases.Contributors.List;

namespace ShoppingProject.Infrastructure.Data.Queries;
...
public class ListContributorsQueryService : IListContributorsQueryService
{
  ...
  public async Task<UseCases.PagedResult<ContributorDto>> ListAsync(int page, int perPage)
  {
    ...
    return new UseCases.PagedResult<ContributorDto>(new List<ContributorDto>(), page, perPage, 0, 0);
  }
}
